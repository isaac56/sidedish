...
public interface CustomizedProductRepository {
    ...
    @Query("select A.id, A.hash, A.provider_id, A.name, A.description, A.price_original, A.price_discount, A.point, A.top_image_url, A.stock from category_has_product AB " +
